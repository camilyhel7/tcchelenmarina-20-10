...
<body>
        <a class="btfafa" href="listaconteudos.php" target="_blank">
          <i class="fa fa-book" ></i>
          Conteúdos Cadastrados
        </a>
        <a class="btfafa" href="listausuarios.php" target="_blank">
          <i class="fa fa-user" ></i>
          Usuários Cadastrados
        </a>
        <a class="btfafa" href="listaquestoes.php" target="_blank">
